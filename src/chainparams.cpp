...
public:
    CMainParams() {
        ...
        // until exactly 100M TLC have been issued (7,200,000 blocks, about 17
        // years at 75 seconds). After that no new coins are ever created:
        // MAX_SUPPLY enforces the 100M cap in consensus.
        ...
        static_assert(10000000 * COIN + 7200000 * (125 * COIN / 10) == MAX_SUPPLY);
